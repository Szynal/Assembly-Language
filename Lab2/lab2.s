...
# _______________________________________________________________________________________
#	
# Wczytac z pliku 2 DUZE liczby w reprezentacji czworkowej (ASCII) [0.5p]
# Wpisac liczby do pamieci (little endian) [2p]
# Wykonac dodawania liczb z użyciem rejestrow 8B i flagi CF (oraz stosu, jesli to konieczne) [1p]
# Zamiana watosci liczby na ciag znakow w reprezentacji szesnastkowej [1p]
# Zapis wyniku do pliku [0.5]
# _______________________________________________________________________________________
